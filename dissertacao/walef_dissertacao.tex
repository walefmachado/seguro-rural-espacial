...
\begin{figure}[H]
	...
	\small
	\subfloat[Rainha\label{fig_queen_2}]{\includegraphics[width=0.15\textwidth]{figuras/cont_queen.png}}\hspace{0.3cm}
...
\def\titlecapa{O seguro rural no Brasil: evolução e distribuição espacial}
...
%\vspace{1cm}
\begin{singlespace}
\noindent\input{../cap1/cap1resumo.tex}
\end{singlespace}
...
%\end{center}
\begin{singlespace}
\noindent   \input{../cap1/cap1abstract.tex}
\end{singlespace}
...
%\vspace{1cm}
\begin{singlespace}
\noindent\input{../cap2/cap2resumo.tex}
\end{singlespace}
...
%\end{center}
\begin{singlespace}
\noindent   \input{../cap2/cap2abstract.tex}
\end{singlespace}
...
%Esta dissertação teve como objetivo analisar ... Para tanto, a dissertação foi dividida em dois artigos. No primeiro, o objetivo foi avaliar... O segundo artigo, por sua vez, teve como objetivo investigar....Como foi discutido no decorrer dos dois artigos, ...
